...
import { Component, MeshAttribute, MeshComponent, MeshIndexType, } from '@wonderlandengine/api';
import { property } from '@wonderlandengine/api/decorators.js';
const AxisZ = [0, 0, 1];
export function roundedRectangle(engine, width, height, roundness, resolution, corners = {
    tl: true,
    tr: true,
    br: true,
    bl: true,
...
export function roundedRectangleOutline(engine, width, height, roundness, resolution, borderSize, corners = {
    tl: true,
    tr: true,
    br: true,
    bl: true,
    ...
    let mesh = oldMesh;
    if (oldMesh && oldMesh.vertexCount != vertexCount) {
        throw new Error('InvalidArgument: incorrect vertex count, needs ' + vertexCount.toString());
    }
    if (!mesh) {
...
export class RoundedRectangleMesh extends Component {
    ...
    roundness = 0.2;
    start() {
        this.object.getComponent(MeshComponent).mesh = roundedRectangle(this.engine, this.width, this.height, this.roundness, this.resolution);
    }
    update(dt) {
        /* Called every frame. */
    }
...
__decorate([
    property.int(8)
], RoundedRectangleMesh.prototype, "resolution", void 0);
__decorate([
    property.float(1.0)
], RoundedRectangleMesh.prototype, "width", void 0);
__decorate([
    property.float(1.0)
], RoundedRectangleMesh.prototype, "height", void 0);
__decorate([
    property.float(0.2)
], RoundedRectangleMesh.prototype, "roundness", void 0);
